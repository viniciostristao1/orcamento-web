    ...
    <div className="ui-compacta py-12 text-slate-200">
      ...
      <div className="grid lg:grid-cols-[1fr_auto] gap-10 items-start">
        ...
        <div className="space-y-8">
          ...
          >
            <textarea
              className="campo-tema w-full h-[500px] p-6 font-mono text-base border border-slate-800 rounded-2xl focus:border-blue-500 outline-none transition-colors resize-none text-emerald-50 placeholder-slate-700 overflow-x-auto whitespace-pre scrollbar-hide"
